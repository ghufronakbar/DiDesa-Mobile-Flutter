...
import 'package:konek_mob_flutter/models/PengurusDesaAnggotaModel.dart';
...
class _PengurusDesaPageState extends State<PengurusDesaPage> {
  ...
  Future<PengurusDesaAnggotaModel> fetchData() async {
    final response = await http
        .get(Uri.parse("${URLs.baseUrl}/api/user/pengurusdesa/$token"));
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Container(
                    height: 100, // Tentukan tinggi yang diinginkan di sini
                    child: Card(
                      elevation: 5,
                          ...
                          children: [
                            Expanded(
                              ...
                              child: ClipRRect(
                                ...
                                child: AspectRatio(
                                  aspectRatio: 1, // Aspek rasio gambar
                                  child: Image.network(
                                    pengurus.foto ?? "",
                                    fit: BoxFit
                                        .fill, // Mengatur gambar untuk memenuhi tinggi dan lebar Card
                                  ),
                                ),
                              ),
                            ),
